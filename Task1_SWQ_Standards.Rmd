...
```{r}
# make data frame of sites with low coverage of summer days
  # these will be plotted as separate symbols
...
ggplot() +
  ...
  scale_x_continuous(breaks = 2016:maxyr,
                     labels = as.character(2016:maxyr),
                     limits = c(2016, maxyr)) +
  theme_bw() +
  theme(text = element_text(size = 14),
        axis.text.x = element_text(size = 10),
...
yearf_mat <- matrix(data = rep(1:n_years, n_sites), nrow = n_sites, ncol = n_years, byrow = T)
