...
1a. add way to flag/remove years with low coverage in Jun-Aug
...
7. try adding "/n" or low-sample-size flag to tables
...
# ggsave(
#   "output/Task1_SWQS_loggers/PlotH_days_below_DO_threshold2.png",
#        width = 8,
#        height = 6, dpi = 400)
```
# Biplot of DO and