...
# for(j in 1:n_years){
# 
# logit(theta[2,year]) ~ dnorm(TNC_4slope*year[i])
# 
# }

}")

jags_mod4 <- jagsUI::jags(data = jags_data3,
             model.file = "scripts/AHM_mod2.txt",
             n.iter = 6000, n.burnin = 1000,
             parameters.to.save = c("theta", "alpha0.site",
                                    "mu.alpha0.site",
                                    "sd.alpha0.site",
                                    "beta1", "beta2",
                                    ...
                                    "mu.year.effect",
                                    "tau.year.effect"),
             n.chains = 3, parallel = T, n.thin = 5
             )
...
ggsave("test3.png", width = 7, height = 5, dpi = 400)
