...
# Data: tdata2
# Models:
# temp_mod: temp ~ site + (1 | yearf/dayf)
# temp_mod_hr: temp ~ site + (1 | yearf/dayf/hour)
#             npar    AIC    BIC  logLik deviance Chisq Df Pr(>Chisq)    
# temp_mod      18 201360 201521 -100662   201324                        
# temp_mod_hr   19 116775 116945  -58368   116737 84587  1  < 2.2e-16 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

# trying out fitting Bayesian with brms...
# library(brms)
# stan_model <- brm(temp ~ site + (1 | yearf/dayf/hour),
#              data = tdata2, chains = 3, iter = 2000)
...
bootCI = bootMer(temp_mod_hr, mySumm2, re.form=NA, nsim = 1000,
                 verbose = T)



mm <- model.matrix(terms(temp_mod_hr),newdat)
## or newdat$distance <- mm %*% fixef(fm1)
pvar1 <- diag(mm %*% tcrossprod(vcov(temp_mod_hr),mm))
tvar1 <- pvar1+VarCorr(temp_mod_hr)$Subject[1]  ## must be adapted for more complex models
