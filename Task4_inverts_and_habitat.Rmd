...
<<<<<<< HEAD
  ...
  annotate("text", x = 0+30, y = 2, vjust = 0, hjust = 0.5,
           ...
           size = 2.5,
             alpha = 0.75) +
=======
  annotate("text", x = 160+2, y = 12.5, vjust = 1, hjust = 0.5,
           label = "Optimal",
           angle = 90, color = color_vector[1],
           size = 2.5) +  
  geom_vline(xintercept = 110, lty = 2, color = color_vector[2],
             alpha = 0.75) +
  annotate("text", x = 110+2, y = 12.5, vjust = 1, hjust = 0.5,
           label = "Sub-optimal",
           angle = 90, color = color_vector[2],
           size = 2.5) +   
  geom_vline(xintercept = 60, lty = 2, color = color_vector[3],
             alpha = 0.75) +
  annotate("text", x = 60+2, y = 12.5, vjust = 1, hjust = 0.5,
           label = "Marginal",
           angle = 90, color = color_vector[3],
           size = 2.5) +    
  geom_vline(xintercept = 0, lty = 2, color = color_vector[4],
             alpha = 0.75) +
  annotate("text", x = 0+2, y = 12.5, vjust = 1, hjust = 0.5,
           label = "Poor",
           angle = 90, color = color_vector[4],
           size = 2.5) +
  geom_hline(yintercept = 63, lty = 2, color = color_vector[1],
             alpha = 0.75) +
  annotate("text", x = 0+25, y = 63+2, vjust = 0, hjust = 0.5,
           label = "Excellent",
           angle = 0, color = color_vector[1],
           size = 2.5) +
  geom_hline(yintercept = 42, lty = 2, color = color_vector[2],
             alpha = 0.75) +
  annotate("text", x = 0+25, y = 42+2, vjust = 0, hjust = 0.5,
           label = "Good",
           angle = 0, color = color_vector[2],
           size = 2.5) +
  geom_hline(yintercept = 21, lty = 2, color = color_vector[3],
             alpha = 0.75) +
  annotate("text", x = 0+25, y = 21+2, vjust = 0, hjust = 0.5,
           label = "Fair",
           angle = 0, color = color_vector[3],
           size = 2.5) +
  geom_hline(yintercept = 0, lty = 2, color = color_vector[4],
             alpha = 0.75) +
  annotate("text", x = 0+25, y = 2, vjust = 0, hjust = 0.5,
           label = "Poor",
           angle = 0, color = color_vector[4],
           size = 2.5) +
>>>>>>> a3c923b57cb5d848f43f98ddaca9922cadfb163c
