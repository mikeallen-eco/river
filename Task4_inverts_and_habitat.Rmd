...
# Check if 2022 macroinvertebrate data exists. If so, then load it.
if(max(grepl(list.files("data/Macro_Habitat/"), pattern = "2022"))==1){

# get name of 2022 data file
file22 <- list.files("data/Macro_Habitat/")[grepl(list.files("data/Macro_Habitat/"), pattern = "2022")]

# Read in Macroinvertebrate data - 2022
...
# Check if 2023 macroinvertebrate data exists. If so, then load it.
if(max(grepl(list.files("data/Macro_Habitat/"), pattern = "2023"))==1){

# get name of 2022 data file
file23 <- list.files("data/Macro_Habitat/")[grepl(list.files("data/Macro_Habitat/"), pattern = "2023")]

# Read in Macroinvertebrate data - 2023
...
# Check if 2024 macroinvertebrate data exists. If so, then load it.
if(max(grepl(list.files("data/Macro_Habitat/"), pattern = "2024"))==1){

# get name of 2022 data file
file24 <- list.files("data/Macro_Habitat/")[grepl(list.files("data/Macro_Habitat/"), pattern = "2024")]

# Read in Macroinvertebrate data - 2024
...
# Check if 2025 macroinvertebrate data exists. If so, then load it.
if(max(grepl(list.files("data/Macro_Habitat/"), pattern = "2025"))==1){

# get name of 2025 data file
file25 <- list.files("data/Macro_Habitat/")[grepl(list.files("data/Macro_Habitat/"), pattern = "2025")]

# Read in Macroinvertebrate data - 2025
...
#   first just the files from 2016-2021
inv_tmp <- inv16 %>%
  bind_rows(inv17) %>%
  bind_rows(inv18) %>%
  bind_rows(inv19) %>%
...
# now add 2022 up through 2025 (only if they exist!)
if(is.object(inv22)){inv_tmp <- inv_tmp %>% bind_rows(inv22)}
if(is.object(inv23)){inv_tmp <- inv_tmp %>% bind_rows(inv23)}
if(is.object(inv24)){inv_tmp <- inv_tmp %>% bind_rows(inv24)}
if(is.object(inv25)){inv_tmp <- inv_tmp %>% bind_rows(inv25)}
...
if(is.object(inv22)){rm(inv22)}
if(is.object(inv23)){rm(inv23)}
if(is.object(inv24)){rm(inv24)}
if(is.object(inv25)){rm(inv25)}
