...
Plot G: Mean habitat score by monitoring location (points) along with lines showing the maximum and minimum score values for each site across all years. The number of monitoring years for each site is shown on the right margin of the plot.

Plot H: Points show the mean habitat score (x-axis) and mean macroinvertebrate score (y-axis) by monitoring location. The lines show the minimum and maximum score and index values for each site across all years.
...
Plot(s) J: Radar plots for each monitoring site showing the values of the 13 component indices comprising the final habitat score. The abbreviated names on the plots correspond to the index names in the data file as follows: Epifaun. sub. = Epifaunal Substrate/Available Cover; Pool sub. = Pool Substrate Characterization; Pool var. = Pool variability; Sediment dep. = Sediment Deposition; Channel flow = Channel Flow Status; Channel alt. = Channel Alteration; Channel sin. = Channel sinuosity; Bank stab. L = Bank Stability-LB; Bank stab. R = Bank Stability-RB; Bank veg. L = Bank vegetation Protection-LB; Bank veg. R = Bank vegetation Protection-RB; Rip. zone L = Ripariarn Vegetation Zone Width-LB; Rip. zone R = Ripariarn Vegetation Zone Width-RB.

Plot(s) K: Time series plots of the overall habitat score by monitoring site.
