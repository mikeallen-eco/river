...
#                   height = 4, width = 6, dpi = 400)
```
# Plot E - Columbia Dam - DO upstream vs. downstream - raw data by year
upstream: TNC_23, downstream: TNC_25 (& 24), in: 80 & 81
first notch July 2018, completed April 2019
```{r}
coldo %>%
...
#                   height = 5, width = 7, dpi = 400)
```
# Model C - Tree planting temperature trend (downstream - upstream)
TNC_8 - TNC_4
Model to estimate mean trend. Redo plot I showing trend info.
```{r}
treet_jags <- tree %>% 
  filter(is.na(d8.4) == F,
         monthf %in% 5:9) %>%
...
```
# Plotting tree planting temperature modeled mean trend (downstream - upstream)
TNC_8 - TNC_4
Model to estimate mean temperature trend. Redo plot I showing trend info.
```{r}
...
ggsave(here::here("output/Task3_project_impacts/",
                  "PlotI2_tree_planting_up_downstream_diff_by_mo_year_w_trend.png"),
                  height = 5, width = 7, dpi = 400)
