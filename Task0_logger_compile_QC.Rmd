...
To load data from a new year, you will place the excel file into the folder linked to at the end of this code chunk (currently "data/Logger_Data"). It should be formatted exactly like the 2021 file.
```{r}
library(dplyr)
library(here)
library(readxl)
